...
app.get('/player_info/post', function(req, res){
	...
	var playerlist = "SELECT id, name FROM football_players;";
	var spPlayer_info = "SELECT * FROM football_players WHERE id=" + player_id +";";
	var gameCount = "SELECT COUNT(*) FROM football_games WHERE " + player_id + "=ANY(football_games.players);";
	
	db.task('get.everything', task =>{
		return task.batch([
			task.any(playerlist),
			task.any(spPlayer_info),
			task.any(gameCount)
		]);		
	}).then(info =>{
		console.log(info);
